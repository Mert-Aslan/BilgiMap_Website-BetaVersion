...
!function(e) {
  ...
  r.prototype.isBetweenDates = function(e, t) {
      var a, t = t instanceof Array ? (a = new Date(t[0]),
      new Date(t[1])) : (a = new Date(t),
      new Date(t));
  ...
  r.prototype.resize = function() {
      ...
      e.toggleEventList(!1),
      e.windowW <= e.$breakpoints.mobile ? d(window).off("click.evocalendar.evo-" + e.instanceUid) : d(window).on("click.evocalendar.evo-" + e.instanceUid, d.proxy(e.toggleOutside, e))) : (e.options.sidebarDisplayDefault ? e.toggleSidebar(!0) : e.toggleSidebar(!1),
  ...
  r.prototype.buildEventList = function() {
      ...
      if (0 < n.children().length && n.empty(),
  ...
  r.prototype.buildCalendar = function() {
      ...
      for (var a = 1, n = 0; n < 9; n++) {
          for (var i, o = 0; o < t.$label.days.length; o++) {
              a <= t.monthLength && (0 < n || o >= t.startingDay) ? (i = "calendar-day",
      ...
      r && (t.$elements.innerEl.children().removeClass("calendar-active"),
  ...
  r.prototype.addEventIndicator = function(t) {
      ...
      if (e instanceof Array) {
          ...
          t.everyYear && (e = i.formatDate(new Date(e).setFullYear(i.$active.year), i.options.format)),
          d(e);
      function d(e) {
          0 === (n = i.$elements.innerEl.find('[data-date-val="' + e + '"]')).find("span.event-indicator").length && n.append('<span class="event-indicator"></span>'),
          0 === n.find("span.event-indicator > .type-bullet > .type-" + o).length && (a = '<div class="type-bullet"><div ',
          a += 'class="type-' + t.type + '"',
  ...
  r.prototype.selectYear = function(e) {
      var t, a = this;
      "string" == typeof e || "number" == typeof e ? 4 === parseInt(e).toString().length && (t = parseInt(e)) : (e = d(e.target).closest("[data-year-val]"),
      t = d(e).data("yearVal")),
  ...
  r.prototype.selectDate = function(e) {
      ...
      "string" == typeof e || "number" == typeof e || e instanceof Date ? (t = i.formatDate(new Date(e), i.options.format),
  ...
  r.prototype.toggleSidebar = function(e) {
      ...
      t.$UI.hasSidebar = !t.$UI.hasSidebar) : e ? (d(t.$elements.calendarEl).removeClass("sidebar-hide"),
      t.$UI.hasSidebar = !0) : (d(t.$elements.calendarEl).addClass("sidebar-hide"),
      t.$UI.hasSidebar = !1),
  ...
  r.prototype.toggleEventList = function(e) {
      ...
      t.$UI.hasEvent = !0) : (d(t.$elements.calendarEl).addClass("event-hide"),
      t.$UI.hasEvent = !1),
  ...
  r.prototype.addCalendarEvent = function(e) {
      var n = this;
      function t(t) {
          if (t.id || console.log('%c Event named: "' + t.name + "\" doesn't have a unique ID ", "color:white;font-weight:bold;background-color:#e21d1d;"),
          t.date instanceof Array)
              for (var e = 0; e < t.date.length; e++)
                  a(t.date[e]) && (t.date[e] = n.formatDate(new Date(t.date[e]), n.options.format));
          else
              a(t.date) && (t.date = n.formatDate(new Date(t.date), n.options.format));
          function a(e) {
              if (n.isValidDate(e))
                  return 1;
  ...
  d.fn.evoCalendar = function() {
      for (var e, t = this, a = arguments[0], n = Array.prototype.slice.call(arguments, 1), i = t.length, o = 0; o < i; o++)
          if ("object" == typeof a || void 0 === a ? t[o].evoCalendar = new r(t[o],a) : e = t[o].evoCalendar[a].apply(t[o].evoCalendar, n),
          void 0 !== e)
              return e;
      return t
  }
